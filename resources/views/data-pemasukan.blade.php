...
@section('sub-title-link','Data Pemasukan')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card p-5 rounded mb-3">
                <div class="row mb-4">
                    <div class="col-6">
                        <h4>Data Pemasukan Bulan <span class="font-weight-bold">{{$monthName}}</span></h4>
                    </div>
                    <div class="col-6">

                        <button style="float: right;" class="btn btn-outline-primary size-btn" data-toggle="modal" data-target="#modal-filter"><i class="fa fa-filter"></i> Filter</button>
                    </div>
                </div>
