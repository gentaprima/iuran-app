                ...
                <table id="example1" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$row->bank_name}}</td>
                            <td>
                                <button type="button" data-target="#modal-form" data-toggle="modal" onclick="updateData('{{$row->id}}','{{$row->number_account}}','{{$row->account_name}}','{{$row->bank_name}}')" class="btn btn-secondary btn-sm"><i class="fa fa-edit"></i></button>
