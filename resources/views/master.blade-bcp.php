            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#" style="height: 0px !important;">
                        ...
                        <?php }else{ ?>
                        <img src="{{ asset('uploads/profile') }}/{{ Session::get('dataUsers')->photo }}"
                            alt="User Avatar" style="margin-top: -25px;border:3px solid #fff;"
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        @if (Session::get('dataUsers')->role == 0)
                            <li class="nav-item">
                                <a href="/data-iuran"
                                    class="nav-link {{ Request::is('data-iuran') ? 'active' : '' }}">
                        ...
                        <?php if(Session::get('dataUsers')->role == 1){ ?>
                          <li
                              class="nav-item {{ Request::is('data-warga') || Request::is('verifikasi-warga') ? 'menu-open' : '' }}">
                              ...
                              <ul class="nav nav-treeview ">
                                  <li class="nav-item">
                                      <a href="/data-rumah/data-blok"
                                          class="nav-link {{ Request::is('data-blok') ? 'active' : '' }}">
                                  ...
                                  <li class="nav-item">
                                      <a href="/data-rumah"
                                          class="nav-link {{ Request::is('data-rumah') ? 'active' : '' }}">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Data Rumah</p>
                                      </a>
                                  </li>
                        ...
                        <li
                            ...
                            <ul class="nav nav-treeview ">
                                <li class="nav-item">
                                    <a href="/verifikasi-warga"
                                        class="nav-link {{ Request::is('verifikasi-warga') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="/data-warga"
                                        class="nav-link {{ Request::is('data-warga') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Warga</p>
                                    </a>
                                </li>
                        ...
                        @if (Session::get('dataUsers')->role == 1)
                            <li class="nav-item">
                                <a href="/data-iuran-warga"
                                    class="nav-link {{ Request::is('data-iuran-warga') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('data-pemasukan') ? 'menu-open' : '' }}">
                                ...
                                <ul class="nav nav-treeview" style="display: none;">
                                    ...
                                    <li class="nav-item">
                                        <a href="/data-pemasukan"
                                            class="nav-link {{ Request::is('data-pemasukan') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Pemasukan
                                            </p>
                        ...
                        <?php if(Session::get('dataUsers')->role == 1){ ?>
                        <li
                            class="nav-item {{ Request::is('data-rekening') || Request::is('data-jenis-iuran') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ Request::is('data-rekening') || Request::is('data-jenis-iuran') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview ">
                                ...
                                <li class="nav-item">
                                    <a href="/data-jenis-iuran"
                                        class="nav-link {{ Request::is('data-jenis-iuran') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
