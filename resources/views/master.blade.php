        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ui-house" aria-expanded="false" aria-controls="ui-house">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ui-citizen" aria-expanded="false" aria-controls="ui-citizen">
                        ...
                        <div class="collapse" id="ui-citizen">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="/verifikasi-warga">Verifikasi Warga</a></li>
                            </ul>
                        </div>
                    </li>
                    @endif
                    <li class="nav-item">
                        <a class="nav-link" href="{{ Session::get('dataUsers')->role == 0 ? '/data-iuran' : '/data-iuran-warga' }}">
